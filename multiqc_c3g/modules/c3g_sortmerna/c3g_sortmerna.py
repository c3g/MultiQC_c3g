""" C3G MultiQC module for sortmerna. Modified from MultiQC sortmerna module. """
...
class MultiqcModule(RunProcessingBaseModule):
    ...
    Modified to follow C3G's run processing naming formats.
    ...
    def __init__(self):
        ...
        # Parse logs
        self.sortmerna = dict()
        for f in self.find_log_files("c3g_sortmerna", filehandles=True):
